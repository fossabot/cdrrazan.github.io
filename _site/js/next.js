...
$(document).ready(function() {
	...
	about = 'My name is Rajan Bhattarai, and I am a Rails enthusiast and Open Source Promoter. At least thats what i am now',
	writeCode = "I write code especially scatter the letters the editor to correct the keywords and make things right",
	learnMore = "Learn more. Please go here https://cdrrazan.me",
	quote = "There is no spoon.",
	listCommands = 'Available commands: [about] [bio] [clear] [contact] [skills] [social] [portfolio] [quote]',
	commandNotFound = 'Command not found. Don\'t worry, it\'s probably just a glitch in the Matrix. Gli Glitch in the Matrix trix.Error Logged',
	skills = "Main: Ruby on Rails, GIT and Github.\n Familiar with: Node js,  Docker.",
	contact = "Contact me on Twitter -> @cdrrazan";
	// let
	...
	function generateContactHTML() {
		...
		let githubLink = $('<a>Github</a>').attr({
			'href': 'https://github.com/cdrrazan/',
			'target': '_blank'
		});

		let twitterLink = $('<a>Twitter</a>').attr({
			'href': 'https://twitter.com/cdrrazan',
			'target': '_blank'
		});
		...
		let linkedinLink = $('<a>LinkedIn</a>').attr({
			'href': 'https://linkedin.com/in/cdrrazan',
			'target': '_blank'
		})
	...
	function generatePortfolioHTML() {
		...
		let portfolioLink = $('<a>here</a>').attr({
			'href': 'https://about.cdrrazan.me',
			'target': '_blank'
		});

		let portfolioText = "You can see me and my about ";
	...
	let shortBio = 'Self-taught web developer, absolutely passionate about coding and the future of technology. I am constantly learning and expanding my skills. While you are reading this, I am probably busy learning something new. I am interested in startups.';
